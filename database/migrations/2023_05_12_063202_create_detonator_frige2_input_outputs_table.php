...
class CreateDetonatorFrige2InputOutputsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detonator_frige2_input_outputs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('detonator_frige2_input_outputs');
    }
}
